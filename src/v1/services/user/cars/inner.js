...
module.exports.addCarToDriver = async (
  ...
  try {
    ...
    await localStorage.deleteFile(localAvatar.name);
    ...
    await localStorage.deleteFile(localPhoto1.name);
    ...
    await localStorage.deleteFile(localPhoto2.name);
    ...
    await localStorage.deleteFile(localPhoto3.name);
    ...
    await localStorage.deleteFile(localPhoto4.name);
    ...
    await localStorage.deleteFile(localBrochure.name);
    ...
    await localStorage.deleteFile(localDriverLicense.name);
    ...
    await localStorage.deleteFile(localInsurance.name);
    ...
    await localStorage.deleteFile(localPassport.name);
