...
module.exports = {
  ...
  completedChallenge: () =>
    ...
    acceptedTrip:()=>
    new Notificatin(
      "your requist has been accepted",
      "تم قبول طلبك",
      "some dirver accepted your requiest",
      "تم قبول طلبك من احد السائقين"
    ),
    ...
    new Notificatin(
      "driver arrived ",
      "وصل السائق",
      "The driver has reached the specified destination",
      "لقد وصل السائق إلى الوجه المحددة"
    ),
    newTrip:()=>
    new Notificatin(
      "new request",
      "طلب جديد",
      "you have a new request trip",
       "لديك طلب رحله جديد"
    )
};
